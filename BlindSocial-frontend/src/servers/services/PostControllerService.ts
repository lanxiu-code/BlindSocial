...
export class PostControllerService {
    ...
    public static listMyPostVoByPageUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/dev-api/post/my/list/page/vo',
            body: postQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
