...
export class UserControllerService {
    ...
    public static userLoginByWxOpenUsingGet(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/dev-api/user/login/wx_open',
            query: {
                'code': code,
            },
            errors: {
